...
gst_vpu_enc_class_init (GstVpuEncClass * klass)
{
  ...
  if (in_plugin->std != VPU_V_MJPG) {
    g_object_class_install_property (gobject_class, PROP_FORCE_SET_KEYFRAME,
        g_param_spec_boolean ("set-keyframe", "Set Keyframe",
          "Set Keyframe",
    ...
    GParamSpec * pspec)
{
  ...
  switch (prop_id) {
    ...
    case PROP_FORCE_IDR:
      ...
      break;
    case PROP_FORCE_SET_KEYFRAME:
      g_value_set_boolean (value, enc->set_keyframe);
      break;
    default:
    ...
    const GValue * value, GParamSpec * pspec)
{
  ...
  switch (prop_id) {
    ...
    case PROP_FORCE_IDR:
      ...
      break;
    case PROP_FORCE_SET_KEYFRAME:
      enc->set_keyframe = g_value_get_boolean (value);
      break;
    default:
      G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
      break;
